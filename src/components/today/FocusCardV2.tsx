...
/* ── 主组件 ── */
export function FocusCardV2({ card, onStart, onComplete, onItemToggle, onItemAdd, onItemMove, onItemReorder, onCheckin, onSkip, onPause, onContinueTomorrow, busy, demo }: Props) {
